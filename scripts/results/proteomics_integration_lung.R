...
# 
# pdf('./results/scaled/limma/integration/proteomics_lung_Volcano.pdf')
...
# ##############################################################################################################################
# 
# Differential_nodes_lung <- function(networkfile, out, offset = FALSE, log=FALSE, frameshift=FALSE){
#   
#   # networkfile <- './LIONESS/JDS_LIONESS_PCC_2_75_lung_no_doubles_no_loops_HumanNet_top_25000_edges.csv'
#   # offset = TRUE
#   # out <- 'LIONESS'
#   # log <- FALSE
#   # frameshift = FALSE
...
# Lioness_lung_diff_nodes <- Differential_nodes_lung('./LIONESS/JDS_LIONESS_PCC_2_75_lung_no_doubles_no_loops_HumanNet_-1_1scaled_top_25000_edges.csv', 'LIONESS', offset=FALSE, frameshift=TRUE)
# SSN_lung_diff_nodes <- Differential_nodes_lung('./SSN/JDS_SSN_2_75_lung_no_doubles_no_loops_HumanNet_-1_1scaled_top_25000_edges.csv', 'SSN', offset=FALSE, frameshift=TRUE)
# CSN_lung_diff_nodes <-Differential_nodes_lung('./CSN/JDS_CSN_2_75_lung_no_doubles_no_loops_HumanNet.csv', 'CSN_scaled', offset=FALSE, frameshift=TRUE)
# iENA_lung_diff_nodes <-Differential_nodes_lung('./ssPCC/JDS_iENA_2_75_lung_no_doubles_no_loops_HumanNet_-1_1scaled_top_25000_edges.csv', 'ssPCC', offset=FALSE, frameshift=TRUE)
# SSPGI_lung_diff_nodes <-Differential_nodes_lung('./SSPGI/SSPGI_lung_edges_2_75_HumanNet_-1_1scaled_top_25000_edges_symbol.csv', 'SSPGI', offset=FALSE, frameshift=TRUE)
# 
# 
# plots <- list(SSN_lung_diff_nodes, Lioness_lung_diff_nodes, iENA_lung_diff_nodes, CSN_lung_diff_nodes, SSPGI_lung_diff_nodes, plot_final_expr)
...
# Lioness_lung_diff_nodes <- Differential_nodes_lung('./LIONESS/JDS_LIONESS_PCC_2_75_lung_no_doubles_no_loops_HumanNet_top_25000_edges.csv', 'LIONESS', offset=TRUE, frameshift=FALSE)
# SSN_lung_diff_nodes <- Differential_nodes_lung('./SSN/JDS_SSN_2_75_lung_no_doubles_no_loops_HumanNet_top_25000_edges.csv', 'SSN', offset=TRUE, frameshift=FALSE)
# CSN_lung_diff_nodes <-Differential_nodes_lung('./CSN/JDS_CSN_2_75_lung_no_doubles_no_loops_HumanNet.csv', 'CSN_scaled', offset=FALSE, frameshift=FALSE)
# iENA_lung_diff_nodes <-Differential_nodes_lung('./ssPCC/JDS_iENA_2_75_lung_no_doubles_no_loops_HumanNet_top_25000_edges.csv', 'ssPCC', offset=TRUE, frameshift=FALSE)
# SSPGI_lung_diff_nodes <-Differential_nodes_lung('./SSPGI/SSPGI_lung_edges_2_75_HumanNet_top_25000_edges_symbol.csv', 'SSPGI', offset=TRUE, frameshift=FALSE)
# 
# plots <- list(SSN_lung_diff_nodes, Lioness_lung_diff_nodes, iENA_lung_diff_nodes, CSN_lung_diff_nodes, SSPGI_lung_diff_nodes, plot_final_expr)
...
pdf('../results/scaled/limma/integration/proteomics_sample_wise_correlation_lung_scaled.pdf')
