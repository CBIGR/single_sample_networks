...
pdf('../results/density_plots/HumanNet/Edge_densities_combination_HumanNet.pdf')
ggarrange(SSN_lung, NULL, SSN_brain, lioness_lung, NULL, lioness_brain, iENA_lung, NULL, iENA_brain, CSN_lung, NULL, CSN_brain, SSPGI_lung, NULL, SSPGI_brain,
          # labels = c("A","", "B", "C","", "D", "E","","F","G","", "H", "I","", "J"),
          ncol = 3, nrow = 5, widths = c(1,0.3,1,1,0.3,1,1,0.3,1,1,0.3,1,1,0.3,1), common.legend = TRUE)
dev.off()
